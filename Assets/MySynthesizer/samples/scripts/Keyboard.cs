...
public class Keyboard : MonoBehaviour{
    ...
    void Awake() {
        ...
        Text position = transform.Find("Position").GetComponent<Text>();
        Button lshift = transform.Find("LShift").GetComponent<Button>();
        ...
        Button rshift = transform.Find("RShift").GetComponent<Button>();
        ...
        Slider velocity = transform.Find("Velocity").GetComponent<Slider>();
        ...
        Slider volume = transform.Find("Volume").GetComponent<Slider>();
        ...
        KeyProperty hold = transform.Find("Hold").GetComponent<KeyProperty>();
        ...
        KeyProperty damp = transform.Find("Damp").GetComponent<KeyProperty>();
