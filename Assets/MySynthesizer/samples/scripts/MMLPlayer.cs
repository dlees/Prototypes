...
public class MMLPlayer : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        {
            Button button = transform.Find("Panel/ToneEditorButton").GetComponent<Button>();
        ...
        {
            Button button = transform.Find("Panel/ToneEditorCT8Button").GetComponent<Button>();
            button.onClick.AddListener(() =>
            {
                mmlBox.Play("Click");
        ...
        {
            Button button = transform.Find("Panel/PlayButton").GetComponent<Button>();
